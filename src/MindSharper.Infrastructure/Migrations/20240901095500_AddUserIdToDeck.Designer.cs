...
namespace MindSharper.Infrastructure.Migrations
{
    ...
    [Migration("20240901095500_AddUserIdToDeck")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MindSharper.Domain.Entities.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MindSharper.Domain.Entities.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("MindSharper.Domain.Entities.Deck", b =>
                {
                    b.HasOne("MindSharper.Domain.Entities.User", "Owner")
                        .WithMany("OwnedDecks")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
